...
var Home = /*#__PURE__*/function () {
  ...
  return _createClass(Home, [{
    ...
    value: function loadTrending() {
      var _this = this;
      fetch('https://api.themoviedb.org/3/movie/popular?language=en-US&page=1', options).then(function (response) {
        return response.json();
      }).then(function (response) {
        _this.trendingMovies = response.results;
        console.log(_this.trendingMovies);
    ...
    key: "loadTopRated",
    value: function loadTopRated() {
      var _this2 = this;
      fetch('https://api.themoviedb.org/3/movie/top_rated?language=en-US&page=1', options).then(function (response) {
        return response.json();
      }).then(function (response) {
        _this2.topRatedMovies = response.results;
        console.log(_this2.topRatedMovies);
        _this2.renderTopRated();
      })["catch"](function (err) {
        return console.error(err);
      });
    }
    ...
    key: "loadUpcoming",
    value: function loadUpcoming() {
      var _this3 = this;
      fetch('https://api.themoviedb.org/3/movie/upcoming?language=en-US&page=1', options).then(function (response) {
        return response.json();
      }).then(function (response) {
        _this3.upcomingMovies = response.results;
        console.log(_this3.upcomingMovies);
        _this3.renderUpcoming();
      })["catch"](function (err) {
        return console.error(err);
      });
    }
    ...
    key: "renderTrendingItem",
    value: function renderTrendingItem(index) {
      //build html
      return "<div class=\"row resultItem\" id=\"result".concat(index, "\">\n                    <div class=\"col-2\"><img src=\"").concat(IMAGE_URL).concat(this.trendingMovies[index].poster_path, "\" alt=\"Movie Poster\" style=\"width: 90%; height: 90%; max-height: 180px; margin-top: 7%;\"></div> \n                    <div class=\"col-8\"><p><b>Title:</b> ").concat(this.trendingMovies[index].title, " (").concat(this.trendingMovies[index].release_date.substring(0, 4), ")\n                    <br><b>Online Rating:</b> ").concat(this.trendingMovies[index].vote_average, " (").concat(this.trendingMovies[index].vote_count, " \n                    votes)<br><b>Language:</b> ").concat(this.trendingMovies[index].original_language, "</p><br /><b>Description:</b> ").concat(this.trendingMovies[index].overview, "</div>\n                </div>");
    }

    //renders the html for an entire list of searched items
  }, {
    key: "renderTrending",
    value: function renderTrending() {
      var html = '';
    ...
    key: "renderTopRatedItem",
    value: function renderTopRatedItem(index) {
      //build html
      return "<div class=\"row resultItem\" id=\"result".concat(index, "\">\n                    <div class=\"col-2\"><img src=\"").concat(IMAGE_URL).concat(this.topRatedMovies[index].poster_path, "\" alt=\"Movie Poster\" style=\"width: 90%; height: 90%; max-height: 180px; margin-top: 7%;\"></div> \n                    <div class=\"col-8\"><p><b>Title:</b> ").concat(this.topRatedMovies[index].title, " (").concat(this.topRatedMovies[index].release_date.substring(0, 4), ")\n                    <br><b>Online Rating:</b> ").concat(this.topRatedMovies[index].vote_average, " (").concat(this.topRatedMovies[index].vote_count, " \n                    votes)<br><b>Language:</b> ").concat(this.topRatedMovies[index].original_language, "</p><br /><b>Description:</b> ").concat(this.topRatedMovies[index].overview, "</div>\n                </div>");
    }

    //renders the html for an entire list of searched items
  }, {
    key: "renderTopRated",
    value: function renderTopRated() {
      var html = '';
    ...
    key: "renderUpcomingItem",
    value: function renderUpcomingItem(index) {
      //build html
      return "<div class=\"row resultItem\" id=\"result".concat(index, "\">\n                    <div class=\"col-2\"><img src=\"").concat(IMAGE_URL).concat(this.upcomingMovies[index].poster_path, "\" alt=\"Movie Poster\" style=\"width: 90%; height: 90%; max-height: 180px; margin-top: 7%;\"></div> \n                    <div class=\"col-8\"><p><b>Title:</b> ").concat(this.upcomingMovies[index].title, " (").concat(this.upcomingMovies[index].release_date.substring(0, 4), ")\n                    <br><b>Online Rating:</b> ").concat(this.upcomingMovies[index].vote_average, " (").concat(this.upcomingMovies[index].vote_count, " \n                    votes)<br><b>Language:</b> ").concat(this.upcomingMovies[index].original_language, "</p><br /><b>Description:</b> ").concat(this.upcomingMovies[index].overview, "</div>\n                </div>");
    }
...
.noResults{
    margin-left: 5%;
    margin-top: 20%;
}`, "",{"version":3,"sources":["webpack://./src/css/styles.css"],"names":[],"mappings":"AAAA;IACI,iBAAiB;IACjB,oBAAoB;IACpB,WAAW;IACX,gCAAgC;IAChC,iBAAiB;IACjB,YAAY;AAChB;;AAEA;IACI,gBAAgB;IAChB,iBAAiB;IACjB,UAAU;IACV,aAAa;IACb,gBAAgB;AACpB;;AAEA;IACI,YAAY;IACZ,gBAAgB;IAChB,mBAAmB;IACnB,iBAAiB;IACjB,UAAU;AACd;;AAEA;IACI,eAAe;IACf,gBAAgB;IAChB,iBAAiB;AACrB;;AAEA;IACI,gBAAgB;IAChB,iBAAiB;IACjB,aAAa;IACb,gBAAgB;AACpB;;AAEA;IACI,gBAAgB;IAChB,aAAa;AACjB;;AAEA;IACI,gBAAgB;IAChB,iBAAiB;IACjB,aAAa;IACb,gBAAgB;AACpB;;AAEA;IACI,gBAAgB;IAChB,iBAAiB;IACjB,aAAa;IACb,gBAAgB;AACpB;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,eAAe;IACf,cAAc;IACd,SAAS;IACT,WAAW;AACf;;AAEA;IACI;AACJ;;AAEA;IACI,eAAe;IACf,eAAe;AACnB","sourcesContent":[".taskbar{\n    padding-top: 10px;\n    padding-bottom: 10px;\n    float: left;\n    background-color: cornflowerblue;\n    font-size: larger;\n    color: white;\n}\n\n.searchBox{\n    margin-top: 10px;\n    border: 2px solid;\n    width: 70%;\n    height: 650px;\n    overflow-y: auto;\n}\n\n.resultItem{\n    margin: auto;\n    margin-top: 15px;\n    margin-bottom: 15px;\n    border: 2px solid;\n    width: 95%;\n}\n\n.pageNum{\n    margin-top: 4px;\n    margin-left: 4px;\n    margin-right: 4px;\n}\n\n.newReleases{\n    margin-top: 10px;\n    border: 2px solid;\n    height: 650px;\n    overflow-y: auto;\n}\n\n.filters{\n    margin-top: 10px;\n    height: 650px;\n}\n\n.currentList{\n    margin-top: 10px;\n    border: 2px solid;\n    height: 650px;\n    overflow-y: auto;\n}\n\n.lists{\n    margin-top: 10px;\n    border: 2px solid;\n    height: 650px;\n    overflow-y: auto;\n}\n\n.labels{\n    margin-top: 10px;\n}\n\n.listItem{\n    margin-top: 3px;\n}\n\n.listDropDown{\n    width: 300px;\n}\n\n.rename{\n    margin-left: 1%;\n    margin-top: 1%;\n    width: 7%;\n    height: 80%;\n}\n\n.renameInput{\n    margin-top:1%\n}\n\n.noResults{\n    margin-left: 5%;\n    margin-top: 20%;\n}"],"sourceRoot":""}]);
// Exports
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmovieEngine"] = self["webpackChunkmovieEngine"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_bootstrap_dist_js_bootstrap_esm_js-node_modules_bootstrap_dist_css_boots-bd9352","vendors-node_modules_regenerator-runtime_runtime_js"], () => (__webpack_require__("./src/js/index.js")))
