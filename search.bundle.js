...
var Search = /*#__PURE__*/function () {
  ...
  return _createClass(Search, [{
    ...
    key: "submitMovieSearch",
    value: function submitMovieSearch() {
      var _this = this;
      ...
      //make api call
      fetch("https://api.themoviedb.org/3/search/movie?query=".concat(this.search, "&language=english&page=1"), options).then(function (response) {
        return response.json();
      }) //parse response as json
      .then(function (response) {
        console.log(response);
        _this.searchResults = response.results; //save results as array of object literals
        _this.totalPages = response.total_pages; //save total page
        _this.curPage = 1; //make sure curPages is 1 if not first search
        _this.pageOut.innerHTML = _this.curPage;
    ...
    value: function renderSearchItem(index) {
      //build html
      return "<div class=\"row resultItem\" id=\"sr".concat(index, "\">\n                    <div class=\"col-2\"><img src=\"").concat(IMAGE_URL).concat(this.searchResults[index].poster_path, "\" alt=\"Movie Poster\" style=\"width: 90%; height: 90%; margin-top: 7%;\"></div> \n                    <div class=\"col-8\"><p><b>Title:</b> ").concat(this.searchResults[index].title, " (").concat(this.searchResults[index].release_date.substring(0, 4), ")\n                    <br><b>Online Rating:</b> ").concat(this.searchResults[index].vote_average, " (").concat(this.searchResults[index].vote_count, " \n                    votes)<br><b>Language:</b> ").concat(this.searchResults[index].original_language, "</p></div>\n                </div>");
    }
    ...
    value: function renderSearchList() {
      ...
      //add event handlers
      for (var _i = 0; _i < this.searchResults.length; _i++) {
        document.getElementById("sr".concat(_i)).onclick = this.selectResult.bind(this, _i);
      }
    }
    ...
    value: function selectResult(index) {
      ...
      document.getElementById("sr".concat(index)).style.backgroundColor = "yellow";
    }
    ...
    value: function nextPage() {
      ...
      if (this.curPage < this.totalPages) {
        ...
        //make api call
        fetch("https://api.themoviedb.org/3/search/movie?query=".concat(this.search, "&language=english&page=").concat(this.curPage), options).then(function (response) {
          return response.json();
        }).then(function (response) {
          console.log(response);
          _this2.searchResults = response.results;
          _this2.renderSearchList();
        })["catch"](function (err) {
          return console.error(err);
        });
      }
    ...
    value: function prevPage() {
      ...
      if (this.curPage > 1) {
        ...
        fetch("https://api.themoviedb.org/3/search/movie?query=".concat(this.search, "&language=english&page=").concat(this.curPage), options).then(function (response) {
          ...
          console.log(response);
          _this3.searchResults = response.results;
          _this3.renderSearchList();
        })["catch"](function (err) {
          return console.error(err);
        });
      }
    ...
    key: "deselectResults",
    value: function deselectResults() {
      for (var i = 0; i < this.searchResults.length; i++) {
        document.getElementById("sr".concat(i)).style.backgroundColor = 'white';
      }
    }
    ...
    value: function renderSelectedInfo(index) {
      var movie = this.searchResults[index];
      var html = "<div class=\"row\">\n                        <div class=\"col-5\"><img src=\"".concat(IMAGE_URL).concat(movie.poster_path, "\" alt=\"Movie Poster\" style=\"width: 80%; height: 80%; margin-top: 7%;\"></div> \n                        <div class=\"col-7\" style=\"margin-top: 7%;\"><p><b>Title:</b> ").concat(movie.title, " (").concat(movie.release_date.substring(0, 4), ")\n                        <br><b>Online Rating:</b> ").concat(movie.vote_average, " (").concat(movie.vote_count, ") \n                        votes)<br><b>Language:</b> ").concat(movie.original_language, "</p><br /><b>Description:</b> ").concat(movie.overview, "</div>\n                      </div>");
      this.selectedInfo.innerHTML = html;

      //clear old children from select
      var child = this.selectList.lastElementChild;
      while (child) {
    ...
    key: "getListsFromStorage",
    value: function getListsFromStorage() {
      try {
    ...
    value: function addMovie() {
      ...
      var movie = this.searchResults[this.selectedIndex];
      var list = lists[this.selectList.selectedIndex];

      //use form fields to push new object literal to list
      list.push({
        title: movie.title,
        rating: this.formRating.value,
        comments: this.formComments.value,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_bootstrap_dist_js_bootstrap_esm_js-node_modules_bootstrap_dist_css_boots-bd9352","vendors-node_modules_regenerator-runtime_runtime_js"], () => (__webpack_require__("./src/js/search.js")))
